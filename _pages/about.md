...
- **Towards Secure and Robust Vision-Language Models in Autonomous Driving: A Survey for Perception-Oriented and Decision-Oriented Attacks**&nbsp;\[[pdf](https://cje.ejournal.org.cn/article/doi/10.23919/cje.2025.00.095)\]
...
- **MetAdv: A Unified and Interactive Adversarial Testing Platform for Autonomous Driving**&nbsp;\[[pdf](https://arxiv.org/pdf/2508.06534?)\]
...
- **Manipulating Multimodal Agents via Cross-Modal Prompt Injection**&nbsp;\[[pdf](https://arxiv.org/pdf/2504.14348)\]
...
- **Jailbreak Vision-Language Models via Bi-Modal Adversarial Prompt**&nbsp;\[[pdf](https://ieeexplore.ieee.org/abstract/document/11059299)\]
...
- **Multimodal Object Detection by Adaptive Channel Enhancement and Attention Fusion**&nbsp;\[[pdf](https://ieeexplore.ieee.org/abstract/document/11227959/)\]
...
- **Compromising LLM-Driven Embodied Agents with Contextual Backdoor Attacks**&nbsp;\[[pdf](https://ieeexplore.ieee.org/abstract/document/10943262)\]
...
- **Bdefects4NN: A Backdoor Defect Database for Controlled Localization Studies in Neural Networks**&nbsp;\[[pdf](https://www.computer.org/csdl/proceedings-article/icse/2025/056900a606/251mFRB7BE4)\]
...
- **RobustE2E: Exploring the Robustness of End-to-End Autonomous Driving**&nbsp;\[[pdf](https://www.mdpi.com/2079-9292/13/16/3299)\]
...
- **LanEvil: Benchmarking the Robustness of Lane Detection to Environmental Illusions**&nbsp;\[[pdf](https://dl.acm.org/doi/abs/10.1145/3664647.3680761)\]
...
- **Towards Robust Physical-world Backdoor Attacks on Lane Detection**&nbsp;\[[pdf](https://dl.acm.org/doi/abs/10.1145/3664647.3680766)\]
...
- **Attack End-to-End Autonomous Driving through Module-Wise Noise**&nbsp;\[[pdf](https://openaccess.thecvf.com/content/CVPR2024W/AdvML/html/Wang_Attack_End-to-End_Autonomous_Driving_through_Module-Wise_Noise_CVPRW_2024_paper.html)\]
...
- **Enhancing the Transferability of Adversarial Attacks with Stealth Preservation**&nbsp;\[[pdf](https://openaccess.thecvf.com/content/CVPR2024W/AdvML/html/Zhang_Enhancing_the_Transferability_of_Adversarial_Attacks_with_Stealth_Preservation_CVPRW_2024_paper.html)\]
...
- **Exploring the Physical-world Adversarial Robustness of Vehicle Detection**&nbsp;\[[pdf](https://www.mdpi.com/2079-9292/12/18/3921)\]
...
- **Benchmarking the Robustness of Quantized Models**&nbsp;\[[pdf](https://arxiv.org/abs/2304.03968)\]
...
- **Benchmarking the Physical-World Adversarial Robustness of Vehicle Detection**&nbsp;\[[pdf](https://arxiv.org/abs/2304.05098)\]
...
- **Cloud Workload Turning Points Prediction via Cloud Feature-Enhanced Deep Learning**&nbsp;\[[pdf](https://ieeexplore.ieee.org/abstract/document/9737400/)\]
